...
export interface ApiAboutUsPageAboutUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    history_images: Schema.Attribute.Media<'images', true>;
    history_text: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    our_people_text: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    related_industries: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCareersPageCareersPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    benefits_intro: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero_image: Schema.Attribute.Media<'images'>;
    jobs_external_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mission_text: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    values_intro: Schema.Attribute.Text;
    vision_text: Schema.Attribute.RichText;
  };
}
...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    holiday_notice: Schema.Attribute.Text;
    hours_of_operation: Schema.Attribute.Text;
    ...
    survey_url: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGetStartedStepGetStartedStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'get_started_steps';
  info: {
    displayName: 'Get Started Step';
    pluralName: 'get-started-steps';
    singularName: 'get-started-step';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::get-started-step.get-started-step'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    get_started_steps: Schema.Attribute.Relation<
      'oneToMany',
      'api::get-started-step.get-started-step'
    >;
    hero_tagline: Schema.Attribute.String;
    hero_vision_text: Schema.Attribute.Text;
    latest_videos: Schema.Attribute.Relation<'oneToMany', 'api::video.video'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    guides_resources: Schema.Attribute.Component<'shared.file-link', true>;
    hero_image: Schema.Attribute.Media<'images'>;
...
export interface ApiLaboratoryLaboratory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.RichText;
    hero_image: Schema.Attribute.Media<'images'>;
    highlights: Schema.Attribute.Component<'shared.bullet-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    related_industries: Schema.Attribute.Relation<
      ...
      'api::industry.industry'
    >;
    services_offered: Schema.Attribute.Component<'shared.bullet-item', true>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    who_we_support: Schema.Attribute.Component<'shared.bullet-item', true>;
  };
}
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_founder: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    linkedin_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
